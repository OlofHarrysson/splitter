...
def get_fake_words():
  ...
  words = [
    ...
    Word(text='video', start_time=4.3, end_time=4.6),
    Word(text='helper', start_time=4.6, end_time=5.0),
    Word(text='start', start_time=5.0, end_time=5.8),
    Word(text='clip', start_time=5.8, end_time=6.3),
    Word(text='video', start_time=14.4, end_time=14.8),
    Word(text='helper', start_time=14.8, end_time=15.2),
    Word(text='stop', start_time=15.2, end_time=16.0),
    Word(text='clip', start_time=16.0, end_time=16.3),
    Word(text='video', start_time=20.3, end_time=20.6),
    Word(text='helper', start_time=20.6, end_time=21.0),
    ...
    Word(text='video', start_time=34.5, end_time=34.8),
    Word(text='helper', start_time=34.8, end_time=35.1),
    Word(text='add', start_time=35.1, end_time=36.7),
    ...
    Word(text='video', start_time=46.5, end_time=46.8),
    Word(text='helper', start_time=46.8, end_time=47.2),
    Word(text='start', start_time=47.2, end_time=48.1),
    Word(text='clip', start_time=48.1, end_time=48.4),
    Word(text='video', start_time=54.2, end_time=54.5),
    Word(text='helper', start_time=54.5, end_time=54.9),
    Word(text='stop', start_time=54.9, end_time=56.3),
    Word(text='clip', start_time=56.3, end_time=56.7),
    Word(text='video', start_time=63.7, end_time=64.0),
    Word(text='helper', start_time=64.0, end_time=64.4),
    Word(text='add', start_time=64.4, end_time=64.9),
    ...
    Word(text='video', start_time=75.0, end_time=75.4),
    Word(text='helper', start_time=75.4, end_time=75.7),
    Word(text='add', start_time=75.7, end_time=76.3),
