...
class pygoertzel_dtmf:
  def __init__(self, samplerate):
    ...
    self.goertzel_freq = [
      1209.0, 1336.0, 1477.0, 1633.0, 697.0, 770.0, 852.0, 941.0
    ]
    self.s_prev = {}
    self.s_prev2 = {}
    self.totalpower = {}
...
if __name__ == '__main__':
  # load wav file
  # wav = wave.open('music/audacity/dualtone.wav', 'r')
  # wav = wave.open('music/audacity/dualtone_talk.wav', 'r')
  wav = wave.open('music/audacity/dualtone_hard.wav', 'r')
  # wav = wave.open('music/audacity/talk.wav', 'r')
